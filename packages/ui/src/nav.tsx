...
import { APP_DOMAIN, HIDE_BACKGROUND_SEGMENTS, cn, fetcher } from "@artst/utils";
			...
			>
				<div className="flex h-14 items-center justify-between">
					<div className="flex items-center space-x-4">
						<Link
							href={domain === "artst.io" ? "/" : `https://artst.io`}
							{...(domain !== "artst.io" && {
								onClick: () => {
												...
												{FEATURES_LIST.map(({ slug, icon: Icon, title, shortTitle }) => (
													...
													>
														<div className="flex items-center space-x-2">
															...
															<p className="text-sm font-medium text-gray-700">{shortTitle}</p>
														</div>
