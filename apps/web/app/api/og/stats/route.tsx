...
import { ARTST_LOGO, nFormatter, truncate } from "@artst/utils";
import { ImageResponse } from "next/og";
import { NextRequest } from "next/server";

export const runtime = "edge";

const satoshiBLack = fetch(new URL("@/styles/Satoshi-Black.ttf", import.meta.url)).then((res) =>
	res.arrayBuffer(),
);

const satoshiBold = fetch(new URL("@/styles/Satoshi-Bold.ttf", import.meta.url)).then((res) =>
	res.arrayBuffer(),
);
...
export async function GET(req: NextRequest) {
	...
	const domain = req.nextUrl.searchParams.get("domain") || "artst.io";
		...
		(
			<div
				style={{
					...
					backgroundImage: `url(https://artst.io/_static/background.png)`,
				}}
			>
				<img
					src={ARTST_LOGO}
				...
				<h1
					style={{
						...
						background: "linear-gradient(95.78deg, #C7BF00 21.66%, #E43838 86.47%)",
						backgroundClip: "text",
						color: "transparent",
						marginTop: "50px",
						lineHeight: "7rem",
