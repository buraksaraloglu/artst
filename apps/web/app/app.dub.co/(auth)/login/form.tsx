...
import { Button, Google, InfoTooltip } from "@artst/ui";
        ...
        {showSSOOption && (
          <div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <InfoTooltip
                content={`This is your project's unique identifier on ${process.env.NEXT_PUBLIC_APP_NAME}. E.g. app.artst.io/acme is "acme".`}
              />
            </div>
            <input
              id="slug"
