...
import { Background, Footer, LinkPreview, LinkPreviewPlaceholder, Nav } from "@artst/ui";
import { HOME_DOMAIN, constructMetadata } from "@artst/utils";
...
export async function generateMetadata({ params }: { params: { domain: string; key: string } }) {
	...
	return constructMetadata({
		title: "Link Inspector - Inspect a Short Link on Artst to Make Sure It's Safe",
		description:
			"Artst's Link Inspector is a simple tool for inspecting short links on Artst to make sure it's safe to click on. If you think this link is malicious, please report it.",
		noIndex: true,
	});
}
			...
			<main className="flex min-h-screen flex-col justify-between">
				...
				<div className="mx-2 my-10 flex max-w-md flex-col space-y-5 px-2.5 text-center sm:mx-auto sm:max-w-lg sm:px-0 lg:mb-16">
					...
					<h2 className="text-lg text-gray-600 sm:text-xl">
						Inspect a short link on Artst to make sure it's safe to click on. If you think this link
						is malicious, please report it.
					</h2>
