...
import { getSubdomain } from "@artst/utils";
		...
		return (
			<div className="border-t border-gray-200">
				<DnsRecord
					...
					warning="Warning: if you are using this domain for another site, setting this TXT record will transfer domain ownership away from that site and break it. Please exercise caution when setting this record; make sure that the domain that is shown in the TXT verification value is actually the <b><i>domain you want to use on artst.io</i></b> – <b><i>not your production site</i></b>."
				/>
			</div>
		);
	}
					...
					records={[
						{
							...
							value: recordType === "A" ? `76.76.21.21` : `cname.artst.io`,
							ttl: "86400",
						},
					]}
				/>
