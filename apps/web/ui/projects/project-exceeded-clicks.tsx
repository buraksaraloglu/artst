...
import { MaxWidthWrapper, useRouterStuff } from "@artst/ui";
		...
		<MaxWidthWrapper>
			<div className="my-10 flex flex-col items-center justify-center rounded-md border border-gray-200 bg-white py-12">
				...
				<p className="z-10 max-w-sm text-center text-sm text-gray-600">
					Your project has exceeded your monthly clicks limits. We're still collecting data on your
					links, but you need to upgrade to view them.
				</p>
				<BlurImage
