import { Button, Google, Logo, Modal } from "@artst/ui";
		...
		<Modal showModal={showGoogleOauthModal} setShowModal={setShowGoogleOauthModal}>
			<div className="flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-4 pt-8 sm:px-16">
				...
				<p className="text-center text-sm text-gray-500">
					This allows you to sign in to your {process.env.NEXT_PUBLIC_APP_NAME} account with Google.{" "}
					<a
			...
			<div className="flex flex-col space-y-3 bg-gray-50 px-4 py-8 text-left sm:px-16">
				...
				<button
					onClick={() => {
						...
						Cookies.set("hideGoogleOauthModal", new Date().toISOString(), { expires: 14 });
					}}
