...
import { Facebook, LinkedIn, LoadingCircle, Photo, Twitter } from "@artst/ui";
	...
	const previewImage = useMemo(() => {
		...
		if (image) {
			if (image.startsWith("https://res.cloudinary.com")) {
				...
				return <img src={image} alt="Preview" className="h-[250px] w-full object-cover" />;
			}
		} else {
			return (
				<div className="flex h-[250px] w-full flex-col items-center justify-center space-y-4 bg-gray-100">
