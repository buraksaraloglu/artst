...
import { Button, Copy, InfoTooltip, Logo, Modal, SimpleTooltipContent, Tick } from "@artst/ui";
import { HOME_DOMAIN, SAML_PROVIDERS } from "@artst/utils";
							...
							<div>
								...
								<div className="mt-1 flex w-full items-center justify-between rounded-md border border-gray-300 bg-white px-3 py-2 shadow-sm">
									...
									<button
										...
										className="pl-2"
										onClick={() => {
											navigator.clipboard.writeText(scim.directories[0].scim.endpoint as string);
								...
								<div className="mt-1 flex w-full items-center justify-between rounded-md border border-gray-300 bg-white px-3 py-2 shadow-sm">
									...
									<div className="flex space-x-2 pl-2">
										<button
											type="button"
											onClick={() => {
												navigator.clipboard.writeText(`${scim.directories[0].scim.secret}`);
