...
import { FADE_IN_ANIMATION_SETTINGS, capitalize } from "@artst/utils";
...
function AddEditDomainModal({
    ...
    */
	...
	return (
		<Modal showModal={showAddEditDomainModal} setShowModal={setShowAddEditDomainModal}>
			...
			>
				...
				{expanded && (
					<motion.div {...FADE_IN_ANIMATION_SETTINGS} className="flex flex-col space-y-6">
						<div className="flex items-center justify-between bg-gray-50">
							<div className="flex items-center space-x-2">
								<h2 className="text-sm font-medium text-gray-900">Primary Domain</h2>
						...
						<div>
							<label htmlFor="placeholder" className="flex items-center space-x-2">
								<h2 className="text-sm font-medium text-gray-900">Input Placeholder URL</h2>
...
export function useAddEditDomainModal({ props }: { props?: DomainProps } = {}) {
	...
	const AddEditDomainButtonCallback = useCallback(() => {
		return <AddEditDomainButton setShowAddEditDomainModal={setShowAddEditDomainModal} />;
	}, [setShowAddEditDomainModal]);
	...
	return useMemo(
		...
		[setShowAddEditDomainModal, AddEditDomainModalCallback, AddEditDomainButtonCallback],
	);
}
