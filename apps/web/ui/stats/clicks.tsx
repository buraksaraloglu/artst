...
import { NumberTooltip, useRouterStuff } from "@artst/ui";
import { COUNTRIES, capitalize, linkConstructor, nFormatter } from "@artst/utils";
		...
		<div className="max-w-4xl border border-gray-200 bg-white p-5 sm:rounded-lg sm:border-gray-100 sm:p-10 sm:shadow-lg">
			<div className="mb-5 flex items-start justify-between space-x-4">
				<div className="flex-none">
					...
					<p className="text-sm font-medium uppercase text-gray-600">Total Clicks</p>
				</div>
