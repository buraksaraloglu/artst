...
import { LoadingSpinner, Modal, useRouterStuff } from "@artst/ui";
import { GOOGLE_FAVICON_URL, fetcher } from "@artst/utils";
...
export default function Referer() {
	const { baseApiPath, queryString, totalClicks, modal } = useContext(StatsContext);
